...
def establishCommandChannel():
    ...
    connectionAPI = 'https://api.mediatek.com/mcs/v2/devices/%(device_key)s/connections.csv'
    r = requests.get(connectionAPI % DEVICE_INFO,
                 headers = {'deviceKey' : DEVICE_INFO['SfsHQXMmZPeDJi0X'],
